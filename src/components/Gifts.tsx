    ...
    <section className="relative py-10 md:py-16 px-4 bg-[#050505] flex flex-col items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl w-full flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 w-full mb-1 px-2 md:px-0">
          ...
          <AnimatedSection once delay={0.2} className="flex flex-col items-center text-center bg-[#0a0a0a]/80 backdrop-blur-xl p-6 md:p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.8),inset_0_0_20px_rgba(255,0,127,0.05)] border border-white/10 h-full relative overflow-hidden">
             
             {/* Destello sutil en el borde superior */}
             <div className="absolute top-0 left-1/4 right-1/4 h-px bg-linear-to-r from-transparent via-[#ff007f]/50 to-transparent"></div>
          ...
          <AnimatedSection once delay={0.4} className="flex flex-col items-center justify-center text-center bg-[#0a0a0a]/80 backdrop-blur-xl p-6 md:p-12 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.8),inset_0_0_20px_rgba(192,192,192,0.05)] border border-white/10 h-full relative overflow-hidden">

             <div className="absolute top-0 left-1/4 right-1/4 h-px bg-linear-to-r from-transparent via-[#c0c0c0]/50 to-transparent"></div>

             <div className="relative w-28 h-28 md:w-36 md:h-36 mb-2 transition-transform duration-700 hover:scale-105">
                <Image 
